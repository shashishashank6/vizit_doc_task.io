    ...
    <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
        <div class="container">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="/cms/index">CMS</a>
            </div>
            ...
            <div class="col-md-8">
                ...
                if($page==""||$page==1){
                    ...
                    $page_1=($page*5)-5;
                        ...
                        $count_posts=mysqli_query($connection,$post_query_count);
...
<!--                    <h3><?php /*echo $count;?*/ ?></h3>-->
                ...
                <img class="img-responsive" src="images/<?php echo $post_image;?>" alt="" title="Posted on: <?php echo $post_date; ?>">
                </a>
                <hr>
...
<?php
      ...
      <iframe width="560" height="315" src="https://www.youtube.com/embed/sBzRwzY7G-k?autoplay=0" frameborder="0" allowfullscreen></iframe>
        <hr>
          <ul class="pager">
        <?php
        for($i=1;$i<=$count;$i++){
